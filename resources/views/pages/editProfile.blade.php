                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <div class="box-shadow-2 p-0">
                                            <div  class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                                ...
                                                <div class="form-group mt-1 mb-0 p-2">                                                                                                    
                                                    <textarea id="userinput8" rows="4" class="form-control border-cont-form-orange editor" name="work" placeholder="Work">{!!Auth::user()->work!!}</textarea>
                                                        <div class="mt-2 p-1">
                                                            <p><i>Work.</i></p>
                                                        </div> 
                                                </div>                                                                          
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <div class="box-shadow-2 p-0">
                                            <div id="userInputEdu" class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                                ...
                                                <div class="form-group mt-1 mb-0 p-2">                                                                                                   
                                                    <textarea id="userinput8" rows="2" class="form-control border-cont-form-orange editor" name="education">{!!Auth::user()->education!!}</textarea> 
                                                        <div class="mt-2 p-1">
                                                            <p><i>Education.</i></p>                                                        
                                                        </div> 
                                                </div>
