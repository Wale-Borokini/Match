<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="mt-5 ml-2 main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item">
          <a class="sidebar-txt-hov" href="#"><span class="menu-title">Code of Conduct</span></a>
        </li>
        <li class=" nav-item">
          <a class="sidebar-txt-hov" href="#"><span class="menu-title">Staying Safe</span></a>
        </li>
        <li class=" nav-item">
          <a class="sidebar-txt-hov" href="#"><span class="menu-title">Contact</span></a>
        </li>
        @if (Auth::user())
